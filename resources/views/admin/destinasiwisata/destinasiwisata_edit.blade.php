    ...
    <div class="container">
        <div class="card mt-5">
            <div class="card-header text-center">
                Data Destinasi Wisata - <strong>EDIT DATA</strong>
            </div>
            <div class="card-body">
                ...
                <form method="post" action="/admin/destinasiwisata/update/{{$destinasiwisata->id}}" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        value="{{$destinasiwisata->namadestinasi}}">
                    ...
                    <div class="form-group">
                        ...
                        value="{{$destinasiwisata->lokasidestinasi}}">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="deskripsi" class="form-control" placeholder="Deskripsi ..">{{$destinasiwisata->deskripsi}}</textarea>
...
var msg  = "Edit Destinasi Wisata || Web Wisata Karo";
var res = " ";
var speed = 100;
var pos = val;
var le = msg.length;
