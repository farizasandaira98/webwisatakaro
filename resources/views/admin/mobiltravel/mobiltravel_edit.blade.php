  ...
  <div class="container">
    <div class="card mt-5">
      <div class="card-header text-center">
        Data Mobil Travel  - <strong>EDIT DATA</strong>
      </div>
      <div class="card-body">
        ...
        <form method="post" action="/admin/mobiltravel/update/{{$mobiltravel->id}}" enctype="multipart/form-data">

          {{ csrf_field() }}
          <div class="form-group">
            <label>Nama Mobil Travel </label>
            <input type="text" name="namamobil" class="form-control" placeholder="Nama Mobil Travel  .."
            value="{{$mobiltravel->namamobil}}">
          ...
          <label>Input Gambar Mobil Travel </label>
...
<script type="text/javascript">
  ...
  function titlebar(val){
    var msg  = "Edit Mobil Travel  || Web Wisata Karo";
    var res = " ";
    var speed = 100;
    var pos = val;
    var le = msg.length;
