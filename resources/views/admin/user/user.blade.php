...
<head>
  ...
  <title>Admin Web Wisata Karo | Data User</title>
  ...
  <link rel="stylesheet" href="{{asset('assets/admin/dist/css/cssuser.css')}}">
  <!-- overlayScrollbars -->
...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <!-- SEARCH FORM -->
    <form class="form-inline ml-3" method="get" action="/admin/user/cari" enctype="multipart/form-data">
        <div class="input-group input-group-sm">
          <input class="form-control form-control-navbar" type="search" placeholder="Cari Data User" aria-label="Search" name="search">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
      <!--<a href="/admin/user/tambah" class="btn btn-primary">Input Data User Baru</a> -->
      </br></br>
      <div class="card">
        <div class="card-body">
                <table>
                  ...
                  @foreach($user as $ang)
                    ...
                    <td style="width:60%;">
                    <b>Nama User :</b> {{ $ang->name }}</br>
                    <b>Jenis Kelamin :</b> {{ $ang->jk }}</br>
                    <b>Nomor Telpon :</b> {{ $ang->notelp }}</br>
                    <b>Alamat :</b> {{ $ang->alamat }}</br>
                    <b>Email :</b> {{ $ang->email }}</br>
                    </td>
                    <td>
                      <a href="/admin/user/hapus/{{ $ang->id }}" class="btn btn-danger" style="width:100%;">Hapus</a>
                    </td>
                    </tr>
                    @endforeach
                  </tbody>
...
var msg  = "Admin Web Wisata Karo | Data User";
var res = " ";
var speed = 100;
var pos = val;
var le = msg.length;
