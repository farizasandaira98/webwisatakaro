...
<head>
  ...
  <title>Admin Web Wisata Karo | Paket Tour</title>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <!-- Data Paket Tour -->
          <li class="nav-item">
            <a href="/admin/pakettour" class="nav-link active">
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Data Paket Tour</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    <section class="content">
      <div class="container-fluid">
      <a href="/admin/pakettour/tambah" class="btn btn-primary">Input Paket Tour Baru</a>
      </br></br>
      <div class="card">
        <div class="card-body">
                <table>
                  ...
                  @foreach($pakettour as $ang)
                    ...
                    <td style="width:60%;">
                    <b>Nama Paket Tour :</b> {{ $ang->namapaket }}</br>
                    <b>Daftar Destinasi :</b> {{ $ang->daftardestinasi }}</br>
                    <b>Harga Paket :</b> {{ $ang->hargapaket }}</br>
                    <b>Deskripsi :</b> {{ $ang->deskripsi }}</br>
                    <b>Mobil Yang Digunakan :</b> {{ $ang->mobil_travels->namamobil }}</br>
                    </td>
                    <td>
                      <a href="/admin/pakettour/edit/{{ $ang->id }}" class="btn btn-warning" style="width:100%;">Edit</a></br></br>
                      <a href="/admin/pakettour/hapus/{{ $ang->id }}" class="btn btn-danger" style="width:100%;">Hapus</a>
                    </td>
                    </tr>
                    @endforeach
                  </tbody>
...
var msg  = "Admin Web Wisata Karo | Paket Tour";
var res = " ";
var speed = 100;
var pos = val;
var le = msg.length;
