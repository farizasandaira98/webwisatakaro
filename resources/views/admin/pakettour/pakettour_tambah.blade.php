    ...
    <div class="container">
        <div class="card mt-5">
            <div class="card-header text-center">
                Data Paket Tour - <strong>TAMBAH DATA</strong>
            </div>
            <div class="card-body">
                ...
                <form method="post" action="/admin/pakettour/store" enctype="multipart/form-data">
...
var msg  = "Tambah Paket Tour || Web Wisata karo";
var res = " ";
var speed = 100;
var pos = val;
var le = msg.length;
